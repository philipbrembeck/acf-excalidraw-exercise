...
test.skip("unselected bound arrow updates when rotating its target element", async () => {
...
test.skip("unselected bound arrows update when rotating their target elements", async () => {
  await render(<Excalidraw />);
